...
#define PLL1_NSEL   2           /* Range [0 -   3]: Pre-divider ratio N       */
#define PLL1_MSEL  49           /* Range [0 - 255]: Feedback-divider ratio M  */
 ...
 *----------------------------------------------------------------------------*/
uint32_t SystemCoreClock = 100000000U; /* System Clock Frequency (Core Clock) */
